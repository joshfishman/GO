...
class gallery_categories extends WP_Widget
{
    ...
    {                                                
        ...
        echo '<ul class="gallery_categories_widget">';
        echo '    <li class="segment-1"><a data-value="all" href="#">'.__('All', 'yiw').'</a></li>';
            ...
            {
                if( $cat->count > 0 ) :
                    ?><li class="segment-<?php echo $cat->term_id ?>"><a href="#<?php //echo get_term_link( $cat->slug, 'category-photo' ) ?>" data-value="<?php echo strtolower(preg_replace('/\s+/', '-', $cat->slug)) ?>"><?php echo $cat->name ?></a></li><?php
                else :
