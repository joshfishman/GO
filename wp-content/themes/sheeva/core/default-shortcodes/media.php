...
function yiw_sc_youtube_func($atts, $content = null) {        
	...
	$html = "<iframe width=\"$width\" height=\"$height\" src=\"http://www.youtube.com/embed/$video_id?wmode=opaque\" frameborder=\"0\" allowfullscreen></iframe>";
...
function yiw_sc_vimeo_func($atts, $content = null) {        
	...
	$html = "<iframe src=\"http://player.vimeo.com/video/$video_id?title=0&amp;byline=0&amp;portrait=0\" width=\"$width\" height=\"$height\" frameborder=\"0\"></iframe>";
